...
Let $\TrCat$ denote the category of traced categories and strong traced functors.\todo{Introduce props}
...
\begin{named}{Theorem A}
	...
	Then there is an equivalence of 1-categories
	$$\CobSetAlg\simeq\TrProp.$$
\end{named}

Let $\Cat{FrCompCat}$ denote the double category whose objects are free compact categories, whose vertical arrows are strong functors, whose horizontal cells are lax monoidal profunctors, and whose 2-cells are monoidal natural transformations. Let $\MMon(\Cat{FrCompCat})$ denote the 2-category of monoid objects in $\Cat{FrCompCat}$.

\begin{named}{Theorem A'}
 Then there is an equivalence of 2-categories
...
\todo{Add something about traced props.}
