...
To give a sense of the essential surjectivity in~\ref{thm:Theorem_A} we will specify here how to construct a
...
\begin{equation}\label{eq:cob and trace pic}
   ...
   \end{tikzpicture}
\end{equation}
\ref{thm:Theorem_A} will be proved in Section~\ref{sec:proof_of_A}.
