...
\begin{theoremA}\label{thm:traced as cob-alg}
...
A technical proof of Theorem~\ref{thm:traced as cob-alg} will be given in Section~\ref{sec:first equivalence} (see Corollary~\ref{cor:traced as cob-alg}), but see Section~\ref{sec:first equivalence} for an intuitive picture-proof.
...
\begin{theoremB}\label{thm:compact lax and strong}
...
\begin{corollaryB}\label{cor:traced lax and strong}
...
In this section, we prove our main results.... It is laid out as follows. \todo{Fill this in.}
...
In this section we will prove Theorem~\ref{thm:compact lax and strong} and Corollary~\ref{cor:traced lax and strong} as corollaries~\ref{cor:ccc's lax and strong} and \ref{cor:int traced cats}.
...
\end{proof}
 ...
 \begin{corollary}\label{cor:int traced cats}
Suppose that $\cat{D}$ is a traced category and its compact closure is $\cat{C}=\Int(\cat{D})$. Then there is an equivalence of categories
\begin{align}\label{dia:traced lax strong}
\Lax(\cat{C},\Cat{Set})\iso\cat{D}/\TrCat_{\bo}
\end{align}
...
\chapter{Combinatorial proof of the main theorem}
