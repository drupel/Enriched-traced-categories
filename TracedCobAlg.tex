...
%objects in $\cat{O'}$; that is, it induces a function $\Ob F\colon\LabSet\to\TM(\cat{O'})$, where
...
%(\ref{eq:single_fiber}) for varying $\LabSet$ into a single functor, and we have the following main
