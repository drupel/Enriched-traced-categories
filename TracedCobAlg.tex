...
\cite{Shulman}). In Section~\ref{sec:internal_presheaves} we define copresheaves
internal to an equipment, which will allow us to reformulate our main theorems in terms of
equipments. Section~\ref{sec:monoids_bimods} recalls monoids and bimodules in an equipment and
