...
We define the equipments
   \begin{align*}
      \dFrMonProf&\coloneqq\dMod(\dMonProf_{\TM})\\
      \dFrTrProf&\coloneqq \dMod(\dTrProf_{\TT})\\
      \dFrCompProf&\coloneqq\dMod(\dCompProf_{\TC})
   \end{align*}
\end{definition}
...
\begin{corollary}\label{cor:TrCat_ObjectFree}
   ...
   \begin{align*}
      \VVer(\dFrMonProf)&\equiv\MMonCat \\
      \VVer(\dFrTrProf)&\equiv\TTrCat \\
      \VVer(\dFrCompProf)&\equiv\CCompCat.
   \end{align*}
\end{corollary}
...
\begin{remark}
   ...
   \end{equation*}
   By combining the definitions of $\dTrProf_{\TT}$ and $\dTrProf$, it is easy to see that the square
   \begin{equation*}
      \begin{tikzcd}
         (\dTrProf_{\TT})_1 \ar[r] \ar[d,two heads] \ar[dr,phantom,"\lrcorner" very near start]
            & \dCompProf_1 \ar[d,two heads] \\
         \FrMonCat\times\FrMonCat \ar[r]
            & \CompCat\times\CompCat
      \end{tikzcd}
   ...
   equipment $\dTrProf_{\TT}$ can be defined formally, purely in terms of $\dCompProf$, $\dMonProf$, and
...
We conclude this section by recording two simple lemmas which will be needed in the proofs of our main
results.
...
\begin{lemma}\label{lem:FrCompProf_Psh_Mon}
   ...
   \begin{equation*}
      \begin{tikzcd}[column sep=-1.5em]
         \CPsh(\dCompProf_{\TC}) \ar[rr,"\equiv"] \ar[dr,two heads]
            && \dFrCompProf_0 \ar[dl,two heads] \\
            & \FrCompCat &
      \end{tikzcd}
   \end{equation*}
\end{lemma}
\begin{proof}
   The equipment functor $\dCompProf_{\TC}\to\dCompProf$ is (by definition) a local equivalence
...
\begin{lemma}\label{lem:FrMonCompProf_Psh_Mon}
   ...
   \begin{equation*}
      \begin{tikzcd}[column sep=-1.5em]
         \CPsh(\dTrProf_{\TT}) \ar[rr,"\equiv"] \ar[dr,two heads]
            && \dFrTrProf_0 \ar[dl,two heads] \\
            & \FrMonCat &
      \end{tikzcd}
   \end{equation*}
\end{lemma}
\begin{proof}
   The equipment functor $\dTrProf_{\TT}\to\dCompProf_{\TC}$ is (by definition) a local equivalence
