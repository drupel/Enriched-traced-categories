...
\begin{proof}
We follow the proof of Proposition~\ref{prop:Prof_is_exact}. Suppose that a monoidal profunctor $M\colon C\tickar C$ has a monoid structure $\bullet\colon M\otimes M\to M$ and $i\colon\Hom_C\to M$. 
\end{proof}
