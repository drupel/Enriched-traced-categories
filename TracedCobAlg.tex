...
indexing category for their algebras, and hence none are actually directly related to traced categories. In fact, they use three different operads, of varying degrees
of similarity to $\Cob$. For example, there is an orthogonal factorization system on $\Cob$ \cite{Abadi}, for
...
$U\colon\dcat{D}\to\dMod(\dcat{D})$, sending $d$ to the unit $d\tickar d$, which is a local
equivalence.
...
functor $M\colon \op{\cat{C}}\times\cat{D}\to\Set$ is equipped with a lax-monoidal structure, where
$\Set$ is endowed with the cartesian monoidal structure. In the bimodule notation, this means that
there is an associative operation assigning to any elements $m_1\in M(c_1,d_1)$ and $m_2\in
M(c_2,d_2)$ an element $m_1\boxtimes m_2\in M(c_1\otimes c_2,d_1\otimes d_2)$ such that
\[
...
\begin{remark}
   ...
   morphisms. We do not draw these pictures here, because they look too much like pictures in
   $\Cob$; indeed, that is what we are trying to prove.
   \todo[author=Patrick]{I'm not sure about the last sentence.}
\end{remark}
...
\begin{proof}
   ...
   \[
      n_2\bullet n_1 \coloneqq \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)\cdot(n_1\boxtimes
      i(\id_{d^*})\boxtimes n_2)\cdot\bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr).
   \]
   ...
   \begin{align*}
      n\bullet i(f) 
      &= \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)
         \cdot (i(f)\boxtimes i(\id_{d^*})\boxtimes n)
         \cdot \bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
      &= \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)
         \cdot (i(f\otimes\id_{d^*})\boxtimes n)
         \cdot \bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
      &= l_e \cdot \bigl((\epsilon_d\cdot i(f\otimes \id_{d^*}))\boxtimes (\id_e\cdot n)\bigr)
         \cdot \bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
      &= l_e \cdot \bigl(i(\epsilon_d\circ (f\otimes \id_{d^*}))\boxtimes (n\cdot\id_d)\bigr)
         \cdot \bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
      &= l_e \cdot \bigl(i(\id_I)\boxtimes n\bigr)
         \cdot \bigl(((\epsilon_d\circ (f\otimes \id_{d^*}))\otimes\id_d)
            \circ(\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
      &= l_e \cdot \bigl(I_N\boxtimes n\bigr)
         \cdot \bigl((\epsilon_d\otimes\id_d)\circ(\id_d\otimes\eta_d)
            \circ(f\otimes\id_I)\circ r_c^{-1}\bigr) \\
      &= l_e \cdot \bigl(I_N\boxtimes n\bigr)
         \cdot \bigl(l_d^{-1}\circ r_d\circ(f\otimes\id_I)\circ r_c^{-1}\bigr) \\
      &= \bigl(l_e\cdot(I_N\boxtimes n)\cdot l_d^{-1}\bigr)
         \cdot \bigl(r_d\circ(f\otimes\id_I)\circ r_c^{-1}\bigr) \\
      &= n\cdot f.
   \end{align*}
   ...
   \begin{align*}
      ...
      &= \bigl(l_{e\otimes e'}\circ(\epsilon_{d\otimes d'}\otimes\id_{e\otimes e'})\bigr) \\
      ...
      &\qquad \cdot \left((\id_{c\otimes c'}\otimes\eta_{d\otimes d'})
         \otimes r_{c\otimes c'}^{-1}\right)\\
      &= \bigl((l_e\otimes l_{e'})\circ(\epsilon_d\otimes\id_{e\otimes I\otimes e'})
      ...
      &= \bigl((l_e\otimes l_{e'})\circ(\epsilon_d\otimes\id_{e\otimes I\otimes e'})\bigr) \\
      ...
      &\qquad \cdot \bigl((\id_{c\otimes I\otimes c'}\otimes\eta_{d'})
            \circ (r_c^{-1}\otimes r_{c'}^{-1})\bigr) \\
      &= \Bigl[\bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)
            \otimes \bigl(l_{e'}\circ(\epsilon_{d'}\otimes\id_{e'})\bigr)\Bigr] \\
      &\qquad \cdot \Bigl[\bigl(n_1\boxtimes i(\id_{d^*})\boxtimes n_2\bigr)
            \boxtimes \bigl(n'_1\boxtimes i(\id_{d'^*})\boxtimes n'_2\bigr)\Bigr] \\
      &\qquad \cdot\Bigl[\bigl((\id_c\otimes\eta_d)\circ r_c^{-1}\bigr)
            \otimes \bigl((\id_{c'}\otimes\eta_{d'})\circ r_{c'}^{-1}\bigr)\Bigr] \\
      &= \Bigl[\bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)
            \cdot \bigl(n_1\boxtimes i(\id_{d^*})\boxtimes n_2\bigr)
            \cdot \bigl((\id_c\otimes\eta_d)\circ r_c^{-1}\bigr)\Bigr] \\
      &\qquad \boxtimes \Bigl[\bigl(l_{e'}\circ(\epsilon_{d'}\otimes\id_{e'})\bigr)
            \cdot \bigl(n'_1\boxtimes i(\id_{d'^*})\boxtimes n'_2\bigr)
            \cdot \bigl((\id_{c'}\otimes\eta_{d'})\circ r_{c'}^{-1}\bigr)\Bigr]
   \end{align*}
   ...
   \begin{align*}
      \phi(n_2\bullet n_1) &=
      \phi\Bigl[\bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)\cdot(n_1\boxtimes
      i_M(\id_{d^*})\boxtimes n_2)\cdot\bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr)\Bigr] \\
      &= \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)\cdot\phi(n_1\boxtimes
   i_M(\id_{d^*})\boxtimes n_2)\cdot\bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
      &= \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)\cdot(\phi(n_1)\boxtimes
\phi(i_M(\id_{d^*}))\boxtimes \phi(n_2))\cdot\bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
      &= \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)\cdot(\phi(n_1)\boxtimes
      i_N(\id_{d^*}))\boxtimes \phi(n_2))\cdot\bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
   ...
   \begin{align*}
      n_2\star n_1
         &= n_2 \star \Bigl[\bigl(l_d\circ(\epsilon_d\otimes\id_d)
               \circ(\id_d\otimes\eta_d)\circ r_d^{-1}\bigr) \cdot n_1 \Bigr] \\
         &= \Bigl[n_2\cdot\bigl(l_d\circ(\epsilon_d\otimes\id_d)\bigr)\Bigr]
               \star \Bigl[\bigl((\id_d\otimes\eta_d)\circ r_d^{-1}\bigr)\cdot n_1\Bigr] \\
         &= \bigl[l_e\cdot(I_M\boxtimes n_2)\cdot(\epsilon_d\otimes\id_d)\bigr]
               \star \bigl[(\id_d\otimes\eta_d)\cdot(n_1\boxtimes I_M)\cdot r_c^{-1}\bigr] \\
         &= \Bigl[l_e\cdot\bigl(i(\epsilon_d)\boxtimes n_2\bigr)\Bigr]
               \star \Bigl[\bigl(n_1\boxtimes i(\eta_d)\bigr)\cdot r_c^{-1}\Bigr] \\
         &= \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)
            \cdot \Bigr[\bigr(i(\id_d)\boxtimes i(\id_{d^*})\boxtimes n_2\bigl)
                  \star \bigr(n_1\boxtimes i(\id_{d^*})\boxtimes i(\id_d)\bigr)\Bigr] \\
         & \qquad \cdot \bigl((\id_c\otimes\eta_d)\circ r_c^{-1}\bigr) \\
         &= \bigl(l_e\circ(\epsilon_d\otimes\id_e)\bigr)
            \cdot \bigl(n_1\boxtimes i(\id_{d^*})\boxtimes n_2\bigr)
            \cdot \bigl((\id_c\otimes \eta_d)\circ r_c^{-1}\bigr) \\
         &= n_2\bullet n_1
...
\begin{proof}
   ...
   \[
      \bigl(l_b\circ(\epsilon_a\otimes\id_b)\bigr)\cdot(i(\id_a)\boxtimes n')\cdot r_a^{-1} \in N(a,b).
   \]
