...
to the category $\CompCat$ of compact categories and strict functors. %whose image is exactly the full subcategory $\CompFrObCat$ spanned by the compact categories that are free-on-objects.  
