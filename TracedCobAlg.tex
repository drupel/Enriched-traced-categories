...
\todo[inline]{Throughout the paper, indicate that strict pullbacks along iso-fibs are also pseudo pullbacks.}
...
\end{corollary}
\begin{proof}
   The equipment functor $\dTrProf\to\dFrCompProf$ is (by definition) a local equivalence
...
\begin{equation*}
	\begin{tikzcd}
		\Mon(\dTrProf)\ar[r,"\ff"]\ar[d,"\bo"']&\TrCat\ar[d]\\
		\MMon(\dTrProf)\ar[r,"\equiv"']&\TTrCat
	\end{tikzcd}
\end{equation*}
