...
\todo[inline]{Fix the following proposition to make it use reflexive coequalizers.}
\begin{proposition}
...
\begin{definition}
  ...
  left orthogonal to every fully faithful morphism.\todo{Is there a less opaque way of saying what bijective-on-objects means in an arbitrary 2-category?}
\end{definition}
...
\todo[inline,author=Patrick]{I tried to wite an openning paragraph, but I'm not sure I'm satisfied
with it. Could somebody have a look?}
In this final section, we briefly record a result providing a construction of a 2-category
bi-equivalent to the 2-category $\TTrCat$ of traced categories, which makes no mention of a trace
operation or the usual traced category axioms. This is a direct consequence of the machinery used to
...
\todo[inline]{There seems to be a systemic error: $\MMonCat, \TTrCat, \CCompCat$ throughout may actually be referring to $\MMonCatStrong, \TTrCatStrong, \CCompCatStrong$ or to $\MMonFrObCat, \TTrFrObCat, \CCompFrObCat$ throughout this section. Probably notation changed at some point, and we forgot to weave it through this section.}
