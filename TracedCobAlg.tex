...
\begin{tikzpicture}[string diagram]
	...
	\draw[ar] (g2) -- +(1cm,0);
	\end{scope}
	\node [above=2pt] at (current bounding box.north) {$(g_1\cdot m_1\cdot f_1)\boxtimes (g_2\cdot m_2\cdot f_2) = (g_1\otimes g_2)\cdot(m_1\boxtimes m_2)\cdot (f_1\otimes f_2)$};
\end{tikzpicture}
\]
