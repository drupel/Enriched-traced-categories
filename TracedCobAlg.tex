...
These equipments have uninteresting vertical 1-categories---they are just the kleisli categories of their respective monads---but they are not impoverished by that fact. For example, we will see in Corollary~\ref{cor:TrCat_ObjectFree} that their vertical 2-categories are equivalent to $\MMonCat, \TTrCat,$ and $\CCompCat$, respectively.
