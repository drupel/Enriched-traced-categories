...
\begin{definition}
   ...
   \begin{compactitem}
      ...
      \item A functor $\odot\colon\dcat{D}_1\times_{\dcat{D}_0}\dcat{D}_1\to\dcat{D}_1$, called
         \emph{horizontal composition}, that is strictly unital in the sense that both of the
         following composites are identity on $\dcat{D}_1$:
         \begin{equation*}
            \begin{tikzcd}
               \dcat{D}_1 \ar[r,shift left,"U\times_{\dcat{D}_0}\dcat{D}_1"]
                     \ar[r,shift right,"\dcat{D}_1\times_{\dcat{D}_0}U"']
                  &[1.5em] \dcat{D}_1 \times_{\dcat{D}_0} \dcat{D}_1
                     \ar[r,"\odot"]
                  &[-1em] \dcat{D}_1
            \end{tikzcd}
         \end{equation*}
         Horizontal composition is required only to be weakly associative, meaning that there is a
         natural isomorphism between the two evident functors
         $\dcat{D}_1\times_{\dcat{D}_0}\dcat{D}_1\times_{\dcat{D}_0}\dcat{D}_1\too\dcat{D}_1$.
   \end{compactitem}
   An \emph{equipment functor} $\dcat{D}\to\dcat{E}$ consists of functors $\dcat{D}_0\to\dcat{E}_0$
   and $\dcat{D}_1\to\dcat{E}_1$ commuting with the frames $L,R$, the unit $U$, and the composition
   $\otimes$. 
\end{definition}
