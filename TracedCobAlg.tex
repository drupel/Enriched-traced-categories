...
In the 2-category $\CCat$, fully faithful and bijective-on-objects functors have the usual definitions.
...
\begin{proof}
It suffices to prove this for $\dMonProf$, since the other two are locally equivalent to it. \todo[inline]{Finish!}
\end{proof}
