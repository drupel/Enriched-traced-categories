...
Our next goal is to show, continuing the assumptions of the previous theorem, that $\pcat{D}$ is
...
category of $\ccat{C}$ with right adjoint $\Ob$, such that a morphism $f$ in $\ccat{C}$ is $\bo$ if
