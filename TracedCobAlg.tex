...
\begin{example}
  ...
  Then $\dMonProf_{\TM}$ is what we call the \emph{object-free} version of $\dMonProf$. There are similar adjunctions with $\dMonProf$ replaced by $\dTrProf$ and $\dCompProf$, which also generate object-free versions. 
\end{example}
