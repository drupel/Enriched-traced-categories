...
This is established in Section~\ref{sec:deducing} by proving the following generalization of \ref{thm:TheoremA_statement}.
...
Our main tool in understanding this result will be the 2-categorical notion of \emph{equipments} and especially equipments of profunctors in monoidal categories, these will be introduced in Sections~\ref{chap:background_equipments}~and~\ref{chap:equipments_monoidal_profunctors} respectively.
...
We will want to work out what a monoid in $\dMonProf$ looks like using the bimodule notation for profunctors. A unit for a monoidal profunctor
...
Example~\ref{ex:monoid_in_Prof}, we additionally require the equations
\begin{gather}
