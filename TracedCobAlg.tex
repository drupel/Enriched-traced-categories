...
$\eta_f\colon\unit(c)\to\comp{f}\odot\conj{f}$ and
$\epsilon_f\colon\conj{f}\odot\comp{f}\to\unit(d)$ for the unit and counit of this adjunction.
...
The forgetful functor $\MOb\colon\Mon(\dcat{D})\to\dcat{D}_0$ extends to an equipment
...
The proof of this theorem will occupy the rest of this section, but first we note that the analogous
