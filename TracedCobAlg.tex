...
\begin{theorem}\label{thm:orthogonal}
   If an equipment $\dcat{D}$ is exact (and hence regular)
   \todo{Why is this "and hence regular" thing here?}
   \todo[author=Patrick]{Because regular $\Rightarrow$ factorization system},
