...
The proof of this result can be found in Section~\ref{sec:deducing}. In order to see how the free-on- objects traced (resp. compact) categories relate to general traced categories, we prove the following result, which is well-known but difficult to find in the literature:
...
\subsection{Monoidal, traced, and compact categories that are free-on-objects}
