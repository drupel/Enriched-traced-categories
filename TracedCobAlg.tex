...
\begin{definition}
   ...
   \begin{equation}
      \begin{tikzcd}
         \Ar{a} \ar[r,bend left,"\dom" domA] \ar[r,bend right,"\cod"' codA]
            & a
         \twocellA{\kappa}
      \end{tikzcd}
   \end{equation}
   ...
   \begin{equation}
      ...
      \end{tikzcd}
   \end{equation}
   Moreover, given another $d'\colon x\to a$, $c'\colon x\to a$, $\alpha'\colon d'\Rightarrow c'$
