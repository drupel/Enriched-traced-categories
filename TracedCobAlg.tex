...
Given $P\colon\LCob{\cat{O}}\to\Set$, constructing \todo{Fix this section.}
...
$(\Cob/\Ob\cat{C})$-algebra from a traced category $(\cat{C},\otimes,I,\Tr)$. The proof of \ref{thm:Theorem_A} can be found in Section~\ref{sec:proof_of_A}. 

For an oriented 0-manifold $X=X^-\sqcup X^+$ over $\Ob\cat{C}$, we
