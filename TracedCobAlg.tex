...
The $\bo,\ff$ factorization system on the 2-category $\MMonCat$ (resp. on $\TTrCat$ and $\CCompCat$), given by Theorem~\ref{thm:orthogonal}, is well-named, in the sense that a morphism is $\bo$ iff it is bijective-on-objects and $\ff$ iff it is fully faithful.
\end{proposition}
