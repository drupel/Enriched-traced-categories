...
\Set\ar[d,"\eta_{Tr}"']\ar[rr,bend left,"\Fun{CompFr}"]\ar[r,"\Fun{TrFr}"]&\TrCat\ar[r,"\Fun{Int}"]\ar[dr,"-/\TrCat_{\bo}"']&\CompCat\ar[d,"\alg"]\\
\Cat{TrKls}\ar[ur,"i_{Tr}"']&&\Cat{Cat}
\end{tikzcd}
$$
The top triangle commutes by Proposition~\ref{prop:free traced and compact}, and the right-hand triangle commutes by \ref{cor:Corollary B}.  \todo{Very easy to finish this.}
