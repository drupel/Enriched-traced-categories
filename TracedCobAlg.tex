...
\item Define the 2-category $\Cat{XFrObCat}$ as the 2-Grothendieck construction of $\Set\To{\Fun{XFr}}\Cat{XCat}\To{-/\XCat_{\bo}}\op{\2Cat}$
...
Define $\XCat_{\bo}$ and $\cat{C}/\XCat_{\bo}$.\todo{finish}

\end{definition} 

\begin{proposition}\label{prop:coslice Xbo}
  There is a pseudo-functor 
  $$-/\XCat_{\bo}\colon\XCat\to\op{\2Cat}$$
  sending any $\cat{C}\in\XCat$ to 2-category $\cat{C}/\XCat_{\bo}$.
  \end{proposition}
\begin{proof}
...
\end{tikzcd}
$$
Consider the composition $\Set\To{\Fun{XFr}}\XCat\To{-/\XCat_{\bo}}\op{\2Cat}$, where the second functor is as defined in Proposition~\ref{prop:coslice Xbo}. Grothendieck....\todo{!}
