...
Suppose $\cat{C}$ and $\cat{D}$ are monoidal categories. A \emph{monoidal profunctor} $M$ from
$\cat{C}$ to $\cat{D}$ is an ordinary profunctor (see Example~\ref{ex:profunctors}) $M\colon
...
transformation if $N$, $F$, and $F'$ are monoidal functors.
...
\begin{tikzpicture}[string diagram]
	...
	\draw[ar] (m2) -- (f);
	\draw[ar] (f) -- +(1cm,0);
	\node [above=2pt] at (current bounding box.north) {$(f\cdot m_2)\bullet (m_1\cdot h) = f\cdot(m_2\bullet m_1)\cdot h$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\draw[ar] (g) -- (m3);
	\draw[ar] (m3) -- +(1cm,0);
	\node [above=2pt] at (current bounding box.north) {$(m_3\cdot g)\bullet m_1 = m_3\bullet(g\cdot m_1)$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\node [above=2pt] at (current bounding box.north) {$I_M\in M(I,I)$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\node at ($(back.west)+(-.25cm,.2cm)$) {\scriptsize $I$};
	\node at ($(back.east)+(.25cm,.2cm)$) {\scriptsize $I$};
	\node [above=2pt] at (current bounding box.north) {$I_M=i(\id_I)$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\end{scope}
	\node [above=2pt] at (current bounding box.north) {$m_1\boxtimes m_2$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\draw[ar] ($(m)-(1cm,0)$) -- (m);
	\draw[ar] (m) -- +(1cm,0);
	\node [above=2pt] at (current bounding box.north) {$I\boxtimes m =  m$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\draw[ar] (g2) -- +(1cm,0);
	\end{scope}
	\node [above=2pt] at (current bounding box.north) {$(g_1\cdot m_1\cdot f_1)\boxtimes (g_2\cdot m_2\cdot f_2) = 
...
\begin{tikzpicture}[string diagram]
	...
	\end{scope}
	\node [above=2pt] at (current bounding box.north) {$m_1\boxtimes m_2 = \sigma_{d_1,d_2}\cdot(m_2\boxtimes m_1)\cdot\sigma_{c_1,c_2}^{-1}$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\end{scope}
	\node [above=2pt] at (current bounding box.north) {$i(f_1\otimes f_2) = i(f_1)\boxtimes i(f_2)$};
\end{tikzpicture}
\]
...
\begin{tikzpicture}[string diagram]
	...
	\draw[ar] (m1') -- (m2');
	\draw[ar] (m2') -- +(1cm,0);
	\node [above=2pt] at (current bounding box.north) {$(m_2\boxtimes m_2')\bullet (m_1\boxtimes m_1') = (m_2\bullet m_1)\boxtimes(m_2'\bullet m_1')$};
\end{tikzpicture}
\]
