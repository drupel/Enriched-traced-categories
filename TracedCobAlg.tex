...
\begin{itemize}
   \item The 2-category $\scat{D}$ has a bijective-on-objects/fully-faithful factorization.
   \item The functor $\iota$ is identity-on-objects, faithful, and locally fully-faithful.
   \item The triple $(\scat{D},\pcat{D},\iota)$ has both arrow objects and mapping path objects
   ...
   \item The functor $U\iota$ preserves fully-faithful morphisms (equivalently, $F$ preserves
   bijective-on-objects morphisms), and $U\iota$ also preserves bijective-on-objects morphisms.
   \item The functor $U$ preserves mapping path objects and reflects identity 2-cells.
   \item The pair ($U\iota,U)$ creates surjective equivalences: given any morphism $f\colon A\to B$
...
Suppose we are in one of the following cases:
\begin{enumerate}
\item that $\scat{D}=\MMonCat$, that $\pcat{D}=\MMonCatStrong$, that $\iota\colon\scat{D}\to\pcat{D}$ is the inclusion, that $\ccat{C}=\CCat$, and that $U\colon\pcat{D}\to\ccat{C}$ is the forgetful functor;
\item that $\scat{D}=\TTrCat$, that $\pcat{D}=\TTrCatStrong$, that $\iota\colon\scat{D}\to\pcat{D}$ is the inclusion, that $\ccat{C}=\CCat_{\cong}$ is the (2,1)-category of categories, functors, natural isomorphisms, and that $U\colon\pcat{D}\to\ccat{C}$ is the forgetful functor; or
\item that $\scat{D}=\CCompCat$, that $\pcat{D}=\CCompCatStrong$, that $\iota\colon\scat{D}\to\pcat{D}$ is the inclusion, that $\ccat{C}=\CCat_{\cong}$ is the (2,1)-category of categories, functors, natural isomorphisms, and that $U\colon\pcat{D}\to\ccat{C}$ is the forgetful functor; or
\end{enumerate}
We will see that the collection $(\scat{D},\pcat{D},\ccat{C},\iota,U)$ is strictifiable.
