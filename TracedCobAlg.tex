...
underlying 1-category.\todo{Comment on underlying 1-category}%
\footnote{
...
and Justin Hilburn for many useful conversations. Thanks also to Tobias Fritz for helpful comments.
...
\end{gather*}
satisfying some equations.\todo{Reference?} The category $\cat{C}$ is \emph{symmetric monoidal} if
...
\end{tikzcd}
\]
satisfying some equations. If $\cat{C}$ and $\cat{D}$ are symmetric monoidal, then $F$ is
