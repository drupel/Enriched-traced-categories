...
\todo{Why is this here? This whole section is about exactness/collapse.}
...
form. Let $\dcat{D}$ be an equipment together with a category $\cat{C}$ and an ``underlying'' functor
...
\begin{definition}
   ...
   where $i\colon\cat{C}_T\to\dcat{D}_0$ is the canonical fully-faithful functor induced by the $F\dashv U$
   adjunction.
