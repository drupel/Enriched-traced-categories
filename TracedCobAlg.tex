...
morphisms are commutative squares (in which the other morphisms need not be isos).
...
Property \ref{item:boff} is proved as \ref{lem:(bo,ff)_really_is} and the exactness of $\dMonProf$,
...
1_a$ and $1_b=fg$, $\epsilon g=1_g$ and $f\epsilon=1_f$. A strong functor $G\colon B\to A$ with
