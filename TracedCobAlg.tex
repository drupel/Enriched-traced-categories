...
\section{Some stuff David moved}
...
\chapter{Appendix: Conmbinatorial proof of the main theorem}
...
\todo{We still need on morphisms-part, and the other direction of the equivalence.}
\end{document} 