...
\begin{remark}
   ...
   actual morphisms of $ C$. We will use the bimodule notation discussed in Section~\ref{sec:profunctors}. The operation $\boxtimes$ of a monoidal profunctor then looks like the
   tensor of morphisms.
\end{remark}
