...
will also show that in any exact (in fact any regular) equipment, ane can define an orthogonal
...
\begin{remark}
  ...
  \todo{Is this meant to be saying that $\MMonCat$, $\TTrCat$, and $\CCompCat$ refer to objectwise-free categories?}
