...
will be fed back into which inputs.  In fact, these generalize \todo{according to Wikipedia this is
not accurate}Penrose diagrams in $\ncat{Vect}$~\cite{}, and the word \emph{traced} originates in
...
This is a morphism in the multicategory $\Cob$, underlying the symmetric monoidal category of
...
must respect these labels \todo[author=Patrick]{And boxes labeled by morphisms?}.  We will thus
