      ...
      \begin{tikzcd}[column sep=.1cm]
         \TrCat(\Col{M}_{\MTCfont{T}},T')
            ...
            &\hspace{.3cm}&
               ...
               \ar[dr, end anchor = {[xshift=-.1cm]north west},"\iso"]
               \ar[dd,"\textrm{--}\circ i'_M"']
               \ar[rr,"\iso"]
            &&\Emb_{\MTCfont{C}}(M,\Int(T')) \ar[dd]
            \\[-.5ex]
            &&&\parbox{.25cm}{~\hspace{-2cm}$\CompCat(\Col{M}_{\MTCfont{C}},\Int(T'))$}
            \ar[ur,start anchor={[xshift=.1cm]north east},"\iso"]
            \ar[dr,start anchor={[xshift=.1cm]south east},"\textrm{--}\circ i_M" description]
            \\[1.5ex]
         \TrCat(T,T')
               \ar[rr,"\eta_{T'}\circ\textrm{--}"]
