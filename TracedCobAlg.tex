...
the traced categories that are objectwise-free.
...
\begin{definition}
   ...
   that are objectwise-free. In other words, using Definition~\ref{def:kleisli_equipment} we may write
   \begin{gather*}
...
\[
   ...
   \CCompFrObCat \to \CCompCatStrong,
\]
comparing objectwise-free and strict functors with arbitrary objects and strong functors. This
...
\section{Monoidal, traced, and compact categories that are objectwise-free}
