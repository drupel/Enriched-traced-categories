...
\begin{remark}
Another way to address the condition of objectwise-free traced categories and strict functors between them is to embrace it and deal with PROPs rather than monoidal categories. In fact, there is an analogue of \ref{thm:TheoremA_statement} in which $\TrFrObCat$ is replaced by $\TrPROP$. We do not prove this result, but we will clarify it at an appropriate time; see Remark~\ref{rem:PROP}.
\end{remark}
