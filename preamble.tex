...
\newcommand{\Prof}{\ccat{P}\Cat{rof}}
\newcommand{\dProf}{\dcat{P}\Cat{rof}}
\newcommand{\MProf}{\ccat{M}\Cat{Prof}}
\newcommand{\dMProf}{\dcat{M}\Cat{Prof}}
\newcommand{\dSpan}{\dcat{S}\Cat{pan}}
\newcommand{\EndoProf}{\Cat{EndoProf}}
\newcommand{\MonCat}{\ccat{M}\Cat{onCat}}
\newcommand{\MonCatLax}{\MonCat_{\mathrm{lax}}}
\newcommand{\SymMonCat}{\ccat{S}\Cat{ymMonCat}}
\newcommand{\CompCat}{\ccat{C}\Cat{ompCat}}
\newcommand{\TrCat}{\ccat{T}\Cat{rCat}}
\newcommand{\TrProp}{\Cat{TrProp}}
\newcommand{\Prop}{\Cat{Prop}}
\newcommand{\Set}{\Cat{Set}}
\newcommand{\Int}{\Fun{Int}}
\def\2Cat{\tn{$2$-$\Cat{Cat}$}}
\def\CobSetAlg{\int^{\Set}(\Cat{Cob}/\bullet)\alg}
\def\CobKlsAlg{\int^{\Cat{Kls}}(\Cat{Cob}/\bullet)\alg}
