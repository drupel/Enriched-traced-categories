...
\newcommand{\MMon}{\dcat{M}\Cat{on}}
\newcommand{\Prof}{\bm{\ccat{P}}\Cat{rof}}
\newcommand{\dProf}{\dcat{P}\Cat{rof}}
\newcommand{\MProf}{\bm{\ccat{M}}\Cat{Prof}}
\newcommand{\dMProf}{\dcat{M}\Cat{Prof}}
\newcommand{\dSpan}{\dcat{S}\Cat{pan}}
\newcommand{\EndoProf}{\Cat{EndoProf}}
\newcommand{\MonCat}{\bm{\ccat{M}}\Cat{onCat}}
\newcommand{\MonCatLax}{\MonCat_{\mathrm{lax}}}
\newcommand{\SymMonCat}{\bm{\ccat{S}}\Cat{ymMonCat}}
\newcommand{\CompCat}{\bm{\ccat{C}}\Cat{ompCat}}
\newcommand{\TrCat}{\bm{\ccat{T}}\Cat{rCat}}
\newcommand{\TrProp}{\Cat{TrProp}}
\newcommand{\Prop}{\Cat{Prop}}
\newcommand{\Set}{\Cat{Set}}
\newcommand{\Int}{\Fun{Int}}
% \def\2Cat{\tn{$2$-$\Cat{Cat}$}}
\newcommand{\CobSetAlg}{\int^{\Set}(\Cat{Cob}/\bullet)\alg}
\newcommand{\CobKlsAlg}{\int^{\Cat{Kls}}(\Cat{Cob}/\bullet)\alg}
