...
\newcommand{\MonCat}{\ncat{MCat}}
\newcommand{\MMonCat}{\nncat{M}{Cat}} % 2-cat MonCat
\newcommand{\MMonCatLax}{\MMonCat_{\mathrm{lax}}}
%\newcommand{\SSymMonCat}{\nncat{S}{ymMonCat}} % 2-cat SymMonCat
\newcommand{\SSymMonCat}{\MMonCat}
\newcommand{\MonProf}{\nncat{M}{Prof}} % bicat MProf (monoidal Prof)
\newcommand{\dMonProf}{\ndcat{M}{Prof}} % double cat MProf (monoidal Prof)
\newcommand{\MProf}{\nncat{M}{Prof}} % just to get old version to compile -- can delete
...
\newcommand{\centerThis}[1]{\vspace{-.2in}\begin{center}#1\end{center}\vspace{-.1in}}
