...
The following are just sketches. Later we can refine them once we have a better idea what we are saying here.
...
%left boxes	
	...
	%middle
	\path(.75,.25);
	\blackbox{(1.5,3.5)}{3}{3}{}{.3}
	%inner
	\path(1.25,.5);
	\blackbox{(.5,.5)}{2}{2}{}{.1}
%left arcs
	%outer
	\directarc{(.25,1.6667)}{(.6,1.125)}
	\directarc{(2.4,1.125)}{(2.75,1.6667)}
	\directarc{(.25,3.333)}{(.6,2)}
	\directarc{(2.4,2.875)}{(2.75,3.333)}
	\fancyarc{(.6,2.875)}{(2.4,2)}{10}{60}
	%inner
	\directarc{(.9,1.125)}{(1.2,.8333)}
	\directarc{(1.8,.8333)}{(2.1,1.125)}
	\directarc{(.9,2.875)}{(2.1,2.875)}
	\directarc{(.9,2)}{(2.1,2)}
	\fancyarc{(1.2,.6667)}{(1.8,.66667)}{5}{-10}
% =
\node at (4,2.5){=};	
%middle boxes
	\path(5,0);
...
%middle arcs
	%outer
	\directarc{(5.45,1.6667)}{(5.5,1.68333)}
	\directarc{(6.05,1.667)}{(6.15,1.6667)}
	\directarc{(5.25,3.333)}{(6.15,2.41667)}
	\directarc{(7.25,1.667)}{(7.75,1.6667)}
	\directarc{(7.25,2.41667)}{(7.75,3.333)}
	\fancyarc{(6.15,3.1667)}{(7.25,3.1667)}{10}{30}
	%inner1
	\directarc{(5.8,1.68333)}{(5.85,1.6667)}
	\fancyarc{(5.5,1.61667)}{(5.8,1.61667)}{3}{-5}
	%inner2
	\directarc{(6.45,1.6667)}{(6.95,1.6667)}
	\directarc{(6.45,2.41667)}{(6.95,3.16667)}
	\directarc{(6.45,3.16667)}{(6.95,2.41667)}
% =
\node at (9,2.5){=};	
%right boxes
	\path(10,0);
	...
	%middle
	\path(10.75,.91667);
	\blackbox{(1.5,1.5)}{1}{1}{}{.3}
	%inner
	\path(11.25,1.3333);
	\blackbox{(.5,.5)}{2}{2}{}{.1}
%right arcs
	%outer
	\directarc{(10.25,3.333)}{(12.75,3.333)}
	\directarc{(10.25,1.6667)}{(10.6,1.667)}
	\directarc{(12.4,1.6667)}{(12.75,1.6667)}
	%inner
	\directarc{(10.9,1.6667)}{(11.2,1.6667)}
	\directarc{(11.8,1.6667)}{(12.1,1.6667)}
	\fancyarc{(11.2,1.5)}{(11.8,1.5)}{10}{-10}
}
\caption{Reduce to the case $\feedcc{\psi\circ\varphi}{Z}{Z}=\feedcc{\psi}{Z}{Z}$.}
\end{figure}
...
%right boxes
	...
	%middle
	\path(5.75,1.25);
	\blackbox{(1.3,2.5)}{1}{0}{}{.3}
	%inner
	\path(6.133,2.25);
	\blackbox{(.5,.5)}{1}{0}{}{.1}	
%right arcs
	\directarc{(5.25,2.5)}{(5.6,2.5)}
	\directarc{(5.9,2.5)}{(6.083,2.5)}
}
\caption{Reduce to the case $\feedcd{\psi\circ\varphi}{Z}{X}=\feedcc{\psi}{Z}{Y}$.}
\end{figure}
...
%left boxes
	...
	%middle
	\path(.75,1.6667);
	\blackbox{(1.3,2.5)}{1}{2}{}{.3}
	%inner
	\path(1.133,3.0333);
	\blackbox{(.6,.6)}{0}{1}{}{.1}
%left arcs
	%outer
	\directarc{(2.2,2.5)}{(2.75,2.5)}
	\fancyarc{(.6,2.9167)}{(2.2,3.333)}{10}{45}
	%inner
	\directarc{(1.783,3.333)}{(1.9,3.333)}
	\directarc{(.9,2.9167)}{(1.9,2.5)}
% =
\node at (4,2.5){=};	
%right boxes
	%outer
	...
	%middle
	\path(5.75,1.25);
	\blackbox{(1.3,2.5)}{0}{1}{}{.3}
	%inner
	\path(6.133,2.25);
	\blackbox{(.5,.5)}{0}{1}{}{.1}	
%right arcs
	\directarc{(7.2,2.5)}{(7.75,2.5)}
	\directarc{(6.683,2.5)}{(6.9,2.5)}
}
\caption{Reduce to the case $\feeddc{\psi\circ\varphi}{X}{Z}=\feeddc{\psi}{Y}{Z}$.}
\end{figure}
...
%left boxes
	...
	%middle
	\path(.75,1.5);
	\blackbox{(1.5,2)}{1}{1}{}{.3}
	%inner
	\path(1.25,2.25);
	\blackbox{(.5,.5)}{1}{1}{}{.1}
%left arcs
	%outer
	\fancyarc{(.6,2.5)}{(2.4,2.5)}{10}{45}
	%inner
	\directarc{(.9,2.5)}{(1.2,2.5)}
	\directarc{(1.8,2.5)}{(2.1,2.5)}
% =
\node at (4,2.5){=};	
%right boxes
	%outer
...
%left arcs
	%outer
	%inner
	\fancyarc{(6.2,2.5)}{(6.8,2.5)}{5}{15}
}
\caption{Reduce to the case $\feeddd{\psi\circ\varphi}{X}{X}=\feedcc{\varphi}{X}{X}$.}
\end{figure}

$$\coprod_Y \big(\Hom(X,Y)\times \Hom(Y,Z)\big)\to\Hom(X,Z)$$
